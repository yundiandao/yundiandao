...
public class ViewMiddle extends LinearLayout implements ViewBaseAction {
	...
	private void init(Context context) {
		...
		for(int i=0;i<10;i++){
			switch(i){
				case 0:{groups.add("附近");}break;
				case 1:{groups.add("推荐商圈");}break;
				case 2:{groups.add("兰山区");}break;
				case 3:{groups.add("罗庄区");}break;
				case 4:{groups.add("河东区");}break;
				case 5:{groups.add("沂水县");}break;
				case 6:{groups.add("郯城县");}break;
				case 7:{groups.add("费县");}break;
				case 8:{groups.add("平邑县");}break;
				case 9:{groups.add("兰陵县");}break;
			}
			...
			for(int j=0;j<15;j++){
				switch (j){
					...
					case 7:{tItem.add(i+"行"+j+"列");}break;
					case 8:{tItem.add(i+"行"+j+"列");}break;
					case 9:{tItem.add(i+"行"+j+"列");}break;
					case 10:{tItem.add(i+"行"+j+"列");}break;
					case 11:{tItem.add(i+"行"+j+"列");}break;
					case 12:{tItem.add(i+"行"+j+"列");}break;
					case 13:{tItem.add(i+"行"+j+"列");}break;
					case 14:{tItem.add(i+"行"+j+"列");}break;
				}
